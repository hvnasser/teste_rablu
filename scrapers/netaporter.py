...
class NetaPorterScraper(BaseScraper):
    site_key = "netaporter"
    ...
    async def search_products(self, brand: str, category: str) -> list[Product]:
        ...
        cat = _CATEGORY_IDS.get(category, "clothing")

        url = (
            f"{self.base_url}/en-us/shop/clothing/{cat}"
            f"?keywords={quote_plus(search_term)}&sortby=discount"
        )
